...
impl WalletApp {
    ...
    /// Create a new wallet
    pub async fn create_wallet(&self, _password: &str) -> Result<WalletAccount> {
    ...
    pub async fn import_wallet(&self, _private_key: &str, _password: &str) -> Result<WalletAccount> {
    ...
    pub async fn send_transaction(
        ...
        // Create transaction
        let memo_clone = request.memo.clone();
